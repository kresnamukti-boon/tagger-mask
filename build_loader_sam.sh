...
for f in rw_panelux.js rw_install.js rw_masktools.js rw_stable.js rw_undo.js rw_commit.js rw_brushpoly.js rw_healinterior.js rw_snap.js rw_textdetect.js rw_sam.js wf_helpers.js; do
  echo -e "\n// ===== $f =====\n" >> console_loader_sam.js
